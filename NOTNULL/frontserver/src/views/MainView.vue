    ...
    <div id="carouselExampleIndicators" class="carousel slide centered-carousel" data-bs-ride="carousel" data-bs-theme="dark">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active test">
          <img :src="main_img" class="d-block w-100" alt="01">
        </div>
        <div class="carousel-item test">
          <img :src="main_img" class="d-block w-100" alt="02">
        </div>
        <div class="carousel-item test">
          <img :src="main_img" class="d-block w-100" alt="03">
        </div>
      </div>
      ...
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img :src="main_img" alt="2021 뉴이어, 스타벅스와 함께 즐겁고 활기차게 시작하세요!" />
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img :src="main_img" alt="기간 내 스타벅스 카드 e-Gift를 3만원 이상 선물 시, 아메리카노 e-쿠폰을 드립니다." />
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img :src="main_img" alt="뉴이어 푸드와 제조 음료를 세트로 구매 시, 뉴이어 음료 BOGO(1+1) 쿠폰을 드립니다." />
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img :src="main_img" alt="신년 MD 상품 포함 3만원 이상 구매 고객께 아메리카노(톨사이즈) 쿠폰을 드립니다." />
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img :src="main_img" alt="2017 DIGITAL LUCKY DRAW 100% 당첨의 행운을 드립니다!" />
