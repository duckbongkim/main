            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" aria-describedby="emailHelp" v-model="editingRating.name">
                    </div>  
                    <div class="mb-3">
                        <label for="rate" class="form-label">적립률</label>
                        <input type="text" class="form-control" id="rate" v-model="editingRating.rate">
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        <label for="name" class="form-label">등급명</label>
                        <input type="text" class="form-control" id="name" aria-describedby="emailHelp" v-model="newRating.name">
                    </div>
                    <div class="mb-3">
                        <label for="rate" class="form-label">적립률</label>
                        <input type="text" class="form-control" id="rate" v-model="newRating.rate">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
export default{ 
    ...
    methods:{
        ...
        async getUserRatings(){
            try{
                const response = await axios.get('http://localhost:3000/admin/users/ratings',{withCredentials:true});
